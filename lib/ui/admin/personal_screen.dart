...
class PersonalScreenAdmin extends StatefulWidget {
  static const routeName = '/personal-admin';

  const PersonalScreenAdmin({super.key});

  @override
  State<PersonalScreenAdmin> createState() => _PersonalScreenAdminState();
}

class _PersonalScreenAdminState extends State<PersonalScreenAdmin> {
